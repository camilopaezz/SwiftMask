...
| **High** | birefnet-general-lite | ~224 MB | [MIT](https://opensource.org/licenses/MIT) (download on first use) |
...
| **Out of memory on large images** | Prefer **Turbo**, **Balanced**, or **High** over **Max Quality** (Max needs more VRAM), or use a smaller source image. GPU OOM may automatically retry on CPU when the backend can detect it. |
...
| High | Generally yes, under [MIT](https://opensource.org/licenses/MIT) (BiRefNet-general-lite via rembg) |
